...
const FooterControlsLeft = (props) => {
    return(
        <div className="footer__controls_left">
            ...
            ? (<span onClick={() => props.updateIsPlaying(true)} className='fa fa-pause fa-2x footer__pause'></span>)
            : (<span onClick={() => props.updateIsPlaying(false)} className='fa fa-play fa-2x footer__play'></span>)}
